...
export const products = [
  ...
  },
  {
    ...
    details:
      "The LA Capone Tee is scheduled to release on June 4, 2026. This capsule piece will be available in multiple colorways and is view-only on the site until the drop goes live.",
  ...
  },
  {
    ...
    details:
      "The LA Capone Hoodie is scheduled to release on June 4, 2026. Customers can preview the grey and black colorways now, but checkout will stay disabled until the drop opens.",
  ...
  },
  {
    ...
    details:
      "The LA Capone Varsity is scheduled to release on June 4, 2026. This product page is live now so customers can browse the red and black colorways before the capsule opens for checkout.",
